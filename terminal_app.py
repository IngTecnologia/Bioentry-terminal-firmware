...
Aplicación para Raspberry Pi con pantalla táctil 480x800 vertical
...
class TerminalUI:
    """Interfaz de usuario para terminal táctil 480x800 vertical"""
    
    def __init__(self, terminal_app):
        self.terminal_app = terminal_app
        self.root = tk.Tk()
        self.screen_width = 480  # Valor por defecto
        self.screen_height = 800  # Valor por defecto
        self.setup_ui()
...
class BioEntryTerminal:
    ...
    def setup_camera(self):
        """Configura la cámara para pantalla 480x800 vertical"""
